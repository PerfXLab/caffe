...
def parse_args():
    ...
    parser.add_argument('--model_def',
                        default='examples/yolov5/yolov5s_v6.0.prototxt')
    parser.add_argument('--image_resize', default=640, type=int)
    parser.add_argument('--model_weights',
                        default='examples/yolov5/yolov5s_v6.0.caffemodel')
    parser.add_argument('--image_file', default='examples/yolov5/bus.jpg')
